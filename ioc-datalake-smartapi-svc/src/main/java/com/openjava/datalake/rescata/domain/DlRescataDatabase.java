...
public class DlRescataDatabase implements Serializable {
    ...
    @ApiModelProperty("是否在数据仓库显示  1显示  0不显示")
    private Long isDatastore;

    public DlRescataDatabase(Long databaseId, String databaseName, String databaseJsonInfo, Long repositoryType, Long databaseType, Long isUseForMount) {
        this.databaseId = databaseId;
        this.databaseName = databaseName;
        this.databaseJsonInfo = databaseJsonInfo;
        this.repositoryType = repositoryType;
        this.databaseType = databaseType;
        this.isUseForMount = isUseForMount;
    }
