...
//    public static final Long RESOURCE_TYPE_VIDEO = 5L;
     ...
     * 资源共享范围 —— 科室私有
     */
    public static final Long RESOURCE_OPEN_SCOPE_DEPT = 4L;
    /**
     * 资源共享范围 —— 部门公开
     */
    public static final Long RESOURCE_OPEN_SCOPE_DEPT_PUBLIC = 5L;

    /**
     * 资源共享范围List
     */
    public static final List<Long> RESOURCE_OPEN_SCOPE_LIST = ImmutableList.of(RESOURCE_OPEN_SCOPE_PUBLIC, RESOURCE_OPEN_SCOPE_DEPT_PUBLIC, RESOURCE_OPEN_SCOPE_INTERNAL, RESOURCE_OPEN_SCOPE_DEPT, RESOURCE_OPEN_SCOPE_PRIVATE);
     ...
     * 目录类型使用范围 —— 科室使用
     */
    public static final Long CATALOG_TYPE_USAGE_SCOPE_DEPT = 4L;
    /**
     * 目录类型使用范围List
     */
    public static final List<Long> CATALOG_TYPE_USAGE_SCOPE_LIST = ImmutableList.of(CATALOG_TYPE_USAGE_SCOPE_PUBLIC, CATALOG_TYPE_USAGE_SCOPE_INTERNAL,CATALOG_TYPE_USAGE_SCOPE_DEPT);
     ...
     * 变更类型
     */
    public static final String DL_RESOURCE_CHANGE_TYPE = "dl.resource.change.type";
    /**
     * 变更类型 —— 新建目录
     */
    public static final Long CHANGE_TYPE_ADD = 1L;
    /**
     * 变更类型 —— 挂载数据
     */
    public static final Long CHANGE_TYPE_PROCESSOR = 2L;
    /**
     * 变更类型 —— 目录上架
     */
    public static final Long CHANGE_TYPE_EFFECTIVE = 3L;
    /**
     * 变更类型 —— 目录共享
     */
    public static final Long CHANGE_TYPE_SHARED = 4L;
    /**
     * 变更类型 —— 目录停更
     */
    public static final Long CHANGE_TYPE_STOP_UPDATE = 5L;
    /**
     * 变更类型 —— 目录更新(目录更新)
     */
    public static final Long CHANGE_TYPE_UPDTE = 6L;
    /**
     * 变更类型 —— 目录下架
     */
    public static final Long CHANGE_TYPE_INVALID = 7L;
    /**
     * 变更类型 —— 目录修改(信息项修改)
     */
    public static final Long CHANGE_TYPE_MODIFY = 8L;
    /**
     * 变更类型 —— 目录删除
     */
    public static final Long CHANGE_TYPE_DELETE = 9L;

    /**
     * 变更类型 —— 目录恢复
     */
    public static final Long CHANGE_TYPE_RECOVERY = 10L;
     ...
     * 资源目录共享属性
     */
    public static final String SHARED_PROPERTY = "dl.resource.shared.property";
     ...
     * 订阅权限状态
     */
    public static final String PERMIT_STATE = "dl.resource.permit.state";

    /**
     * 订阅权限状态 —— 正常
     */
    public static final Long PERMIT_STATE_EFFECTIVE = 1L;

    /**
     * 订阅权限状态 —— 禁用
     */
    public static final Long PERMIT_STATE_FORBIDDEN = 0L;

    /**
     * 订阅数据使用类型 —— 数据查询
     */
    public static final String ACCESS_TYPE = "dl.resource.access.type";

    /**
     * 订阅数据使用类型 —— 数据查询
     */
    public static final Long ACCESS_TYPE_DATA_QUERY = 1L;


    /**
     * 订阅数据使用类型 —— 接口查询
     */
    public static final Long ACCESS_TYPE_INTERFACE_QUERY = 2L;

    /**
     * 加密状态
     */
    public static final String ENCRYPTION_STATE = "dl.encryption.state";
    /**
     * 加密状态-不加密
     */
    public static final Long ENCRYPTION_STATE_No = 0L;
    /**
     * 加密状态-加密
     */
    public static final Long ENCRYPTION_STATE_YES = 1L;
    /**
     * 加密状态-申请不加密
     */
    public static final Long ENCRYPTION_STATE_APPLE_NO = 2L;

    /**
     * 脱敏状态
     */
    public static final String INSENSITIVES_STATE = "dl.insensitives.state";
    /**
     * 加密状态-不脱敏
     */
    public static final Long INSENSITIVES_STATE_No = 0L;
    /**
     * 加密状态-脱敏
     */
    public static final Long INSENSITIVES_STATE_YES = 1L;
    /**
     * 加密状态-2申请不脱敏
     */
    public static final Long INSENSITIVES_STATE_APPLE_NO = 2L;

    /**
     * 社会公开状态
     */
    public static final String OPEN_SOCIETY_STATE = "dl.resource.open.society";
    /**
     * 社会公开状态-不向社会公开
     */
    public static final Long OPEN_SOCIETY_NO = 0L;
    /**
     * 社会公开状态-向社会公开
     */
    public static final Long OPEN_SOCIETY_YES = 1L;


    /**
     * 资源目录挂载状态
     */
    public static final String MOUNT_STATE = "dl.resource.mount";
    /**
     * 资源目录挂载状态-未挂载
     */
    public static final Long MOUNT_STATE_NO = 0L;
    /**
     * 资源目录挂载状态-已挂载
     */
    public static final Long MOUNT_STATE_YES = 1L;
    
    /**
     * 资源目录结构化信息excel导入限制读取数据最大行数
     */
    public static final int MAX_EXCEL_PARSE_ROW = 100;
